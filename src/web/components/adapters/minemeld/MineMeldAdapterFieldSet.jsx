...
class MineMeldAdapterFieldSet extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    return (<fieldset>
      <Input label="Blocklist type"
             ...
             required
             autoFocus
             help={'Select the type of the minemeld blocklist'}
      ...
      <TimeUnitInput label="Refresh blocklist"
                     help={'If enabled, the minemeld blocklist is refreshed when it changed.'}
...
export default MineMeldAdapterFieldSet;
